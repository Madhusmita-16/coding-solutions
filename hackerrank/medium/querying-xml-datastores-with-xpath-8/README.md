...
Your task is to write the XPath selector for finding the number of characters (i.e, the string-length) of the description of the second movie in the XML file.
...
[View on HackerRank](https://www.hackerrank.com/challenges/querying-xml-datastores-with-xpath-8/problem)